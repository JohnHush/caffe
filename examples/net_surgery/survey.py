...
caffe_exm = op.join( caffe_root , 'examples' )
...
caffe.set_mode_cpu()
net = caffe.Net( op.join( caffe_exm , 'net_surgery/conv.prototxt' ), caffe.TEST)
print("blobs {}\nparams {}".format(net.blobs.keys(), net.params.keys()))

# load image and prepare as a single input batch for Caffe
im = np.array(caffe.io.load_image( op.join( caffe_exm , 'images/cat_gray.jpg' ), color=False)).squeeze()
