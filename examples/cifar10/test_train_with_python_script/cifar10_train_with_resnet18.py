...
def cifar10_Solver_ResNet( net_path , base_lr=0.001 , max_iter = 10000 , solver_type = 'SGD'):
...
if __name__ == '__main__':
    ...
    net_path = "/home/jh/working_lib/caffe/examples/cifar10/test_train_with_python_script/ResNet-18-train_val.prototxt"
    cifar10_solver_filename = cifar10_Solver_ResNet( net_path , base_lr=0.1 , max_iter = 100000 , solver_type = 'SGD' )
    ...
    for it in xrange( niter ):
        ...
        if it % 10 == 0 or it +1 == niter:
            ...
            for iit in xrange( 100 ):
                ...
                loss2[it] += output['SoftmaxWithLoss1']
                acc2[it]  += output['Accuracy1']
            loss2[it] /= 100.
            acc2[it] /= 100.
